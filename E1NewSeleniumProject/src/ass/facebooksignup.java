...
public class facebooksignup {
	...
	public static void main(String[] args) {
		...
		driver.get("https://en-gb.facebook.com/r.php");
         ...
         System.out.println("dayDrpdown is multiple:" +result1);
        ...
        System.out.println("monthDrpdown is multiple:" +result2);
        ...
        boolean result3 = monthSelect.isMultiple();
        System.out.println("yearDrpdown is multiple:" +result3);
